...
var _loading_screen_scene:PackedScene = preload("res://scenes/loadingscreen that i stole from sm+/loading_screen.tscn")	## reference to loading screen PackedScene
